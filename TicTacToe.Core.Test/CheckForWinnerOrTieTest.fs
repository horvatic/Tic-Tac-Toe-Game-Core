...
let AI_Won_3X3_Row_No_Does_Have_Horztonal_Victory() =
    let ticTacToeBox = new TicTacToeBox (["-1-"; "-2-"; "-3-"; "-4-"; "X"; "-6-"; "-7-"; "-8-"; "-9-"].ToImmutableArray())
...
let AI_Won_3X3_Row_First_Does_Have_Horztonal_Victory() =
    let ticTacToeBox = new TicTacToeBox (["@"; "@"; "@"; "-4-"; "X"; "-6-"; "-7-"; "-8-"; "-9-"].ToImmutableArray())
...
let AI_Won_3X3_Row_Second_Does_Have_Horztonal_Victory() =
    let ticTacToeBox = new TicTacToeBox (["-1-"; "-2-"; "-3-"; "@"; "@"; "@"; "-7-"; "-8-"; "-9-"].ToImmutableArray())
    Assert.Equal(true, hasHorzontailWin ticTacToeBox gameTestCreate3X3.aIGlyph 0)

[<Fact>]   // test
let AI_Won_3X3_Row_Third_Does_Have_Horztonal_Victory() =
    let ticTacToeBox = new TicTacToeBox (["-1-"; "-2-"; "-3-"; "-4-"; "X"; "-6-"; "@"; "@"; "@";].ToImmutableArray())
    Assert.Equal(true, hasHorzontailWin ticTacToeBox gameTestCreate3X3.aIGlyph 0)

[<Fact>]   // test
let Score_List_Is_Just_False() =
    let scoreList = new TicTacToeBox (["X"; "X"; "-1-"].ToImmutableArray())
    Assert.Equal(false, horzontailTrurthValue scoreList "X" 0 0 3)

[<Fact>]   // test
let Score_List_Has_A_True() =
    let scoreList = new TicTacToeBox (["@"; "@"; "@";].ToImmutableArray())
...
let Check_does_Have_Tie_Has_Tie() =
   let ticTacToeBox = new TicTacToeBox (["X"; "X"; "@"; "@"; "@"; "X"; "X"; "X"; "@"].ToImmutableArray())
...
let Check_does_Have_Tie_Not_Have_Tie() =
   let ticTacToeBox = new TicTacToeBox (["-1-"; "-2-"; "-3-"; "-4-"; "-5-"; "-6-"; "-7-"; "-8-"; "-9-"].ToImmutableArray())
...
let Check_If_AI_Won_Row_3X3_Thrid() =
    let ticTacToeBox = new TicTacToeBox (["-1-"; "-2-"; "-3-"; "-4-"; "-5-"; "-6-"; "@"; "@"; "@"].ToImmutableArray())
    let winningValue = int (getWinningAIValue(gameTestCreate3X3.ticTacToeBoxSize))
    Assert.Equal(winningValue, checkForWinnerOrTie ticTacToeBox gameTestCreate3X3.playerGlyph gameTestCreate3X3.aIGlyph)

[<Fact>]   // test
let Check_If_Human_Won_Row_3X3_First() =
    let ticTacToeBox = new TicTacToeBox (["X"; "X"; "X"; "-4-"; "@"; "-6-"; "-7-"; "-8-"; "-9-"].ToImmutableArray())
...
let Check_If_Human_Won_Row_3X3_Second() =
    let ticTacToeBox = new TicTacToeBox (["-1-"; "-2-"; "-3-"; "X"; "X"; "X"; "-7-"; "-8-"; "-9-"].ToImmutableArray())
    let winningValue = int (getWinningHumanValue(gameTestCreate3X3.ticTacToeBoxSize))
    Assert.Equal(winningValue, checkForWinnerOrTie ticTacToeBox gameTestCreate3X3.playerGlyph gameTestCreate3X3.aIGlyph)

[<Fact>]   // test
let Check_If_Human_Won_Row_3X3_Thrid() =
    let ticTacToeBox = new TicTacToeBox (["-1-"; "-2-"; "-3-"; "-4-"; "-5-"; "-6-"; "X"; "X"; "X"].ToImmutableArray())
    let winningValue = int (getWinningHumanValue(gameTestCreate3X3.ticTacToeBoxSize))
    Assert.Equal(winningValue, checkForWinnerOrTie ticTacToeBox gameTestCreate3X3.playerGlyph gameTestCreate3X3.aIGlyph)

[<Fact>]   // test
let Check_If_AI_Won_3X3_Coulmn_One() =
    let ticTacToeBox = new TicTacToeBox (["@"; "-2-"; "-3-"; "@"; "-5-"; "-6-"; "@"; "-8-"; "-9-"].ToImmutableArray())
    let winningValue = int (getWinningAIValue(gameTestCreate3X3.ticTacToeBoxSize))
    Assert.Equal(winningValue, checkForWinnerOrTie ticTacToeBox gameTestCreate3X3.playerGlyph gameTestCreate3X3.aIGlyph)

[<Fact>]   // test
let Check_If_AI_Won__3X3_Coulmn_Two() =
    let ticTacToeBox = new TicTacToeBox (["-1-"; "@"; "-3-"; "-4-"; "@"; "-6-"; "-7-"; "@"; "-9-"].ToImmutableArray())
    let winningValue = int (getWinningAIValue(gameTestCreate3X3.ticTacToeBoxSize))
    Assert.Equal(winningValue, checkForWinnerOrTie ticTacToeBox gameTestCreate3X3.playerGlyph gameTestCreate3X3.aIGlyph)

[<Fact>]   // test
let Check_If_AI_Won_3X3_Coulmn_Three() =
    let ticTacToeBox = new TicTacToeBox (["-1-"; "-2-"; "@"; "-4-"; "-5-"; "@"; "-7-"; "-8-"; "@"].ToImmutableArray())
    let winningValue = int (getWinningAIValue(gameTestCreate3X3.ticTacToeBoxSize))
    Assert.Equal(winningValue, checkForWinnerOrTie ticTacToeBox gameTestCreate3X3.playerGlyph gameTestCreate3X3.aIGlyph)
...
let Check_If_AI_Won_4X4_Coulmn_Four() =
    let ticTacToeBox = new TicTacToeBox (["-1-"; "-2-"; "-3-"; "@"; 
                        "-5-"; "-6-"; "-7-"; "@"; 
                        "-9-"; "-10-"; "-11-"; "@";
                        "-13-"; "-14-"; "-15-"; "@"].ToImmutableArray())
    let winningValue = int (getWinningAIValue(gameTestCreate4X4.ticTacToeBoxSize))
    Assert.Equal(winningValue, checkForWinnerOrTie ticTacToeBox gameTestCreate3X3.playerGlyph gameTestCreate3X3.aIGlyph)

[<Fact>]   // test
let Check_If_Human_Won_3X3_Coulmn_One() =
    let ticTacToeBox = new TicTacToeBox (["X"; "-2-"; "-3-"; "X"; "-5-"; "-6-"; "X"; "-8-"; "-9-"].ToImmutableArray())
    let winningValue = int (getWinningHumanValue(gameTestCreate3X3.ticTacToeBoxSize))
    Assert.Equal(winningValue, checkForWinnerOrTie ticTacToeBox gameTestCreate3X3.playerGlyph gameTestCreate3X3.aIGlyph)

[<Fact>]   // test
let Check_If_Human_Won_3X3_Coulmn_Two() =
    let ticTacToeBox = new TicTacToeBox (["-1-"; "X"; "-3-"; "-4-"; "X"; "-6-"; "-7-"; "X"; "-9-"].ToImmutableArray())
    let winningValue = int (getWinningHumanValue(gameTestCreate3X3.ticTacToeBoxSize))
    Assert.Equal(winningValue, checkForWinnerOrTie ticTacToeBox gameTestCreate3X3.playerGlyph gameTestCreate3X3.aIGlyph)

[<Fact>]   // test
let Check_If_Human_Won_3X3_Coulmn_Three() =
    let ticTacToeBox = new TicTacToeBox (["-1-"; "-2-"; "X"; "-4-"; "-5-"; "X"; "-7-"; "-8-"; "X"].ToImmutableArray())
    let winningValue = int (getWinningHumanValue(gameTestCreate3X3.ticTacToeBoxSize))
    Assert.Equal(winningValue, checkForWinnerOrTie ticTacToeBox gameTestCreate3X3.playerGlyph gameTestCreate3X3.aIGlyph)

[<Fact>]   // test
let Check_If_Ai_Won_Right_3X3_Diangle() =
    let ticTacToeBox = new TicTacToeBox (["@"; "-2-"; "-3-"; "-4-"; "@"; "-6-"; "-7-"; "-8-"; "@"].ToImmutableArray())
    let winningValue = int (getWinningAIValue(gameTestCreate3X3.ticTacToeBoxSize))
    Assert.Equal(winningValue, checkForWinnerOrTie ticTacToeBox gameTestCreate3X3.playerGlyph gameTestCreate3X3.aIGlyph)

[<Fact>]   // test
let Check_If_Ai_Won_Left_3X3_Diangle() =
   let ticTacToeBox = new TicTacToeBox (["-1-"; "-2-"; "@"; "-4-"; "@"; "-6-"; "@"; "-8-"; "-9-"].ToImmutableArray())
   let winningValue = int (getWinningAIValue(gameTestCreate3X3.ticTacToeBoxSize))
   Assert.Equal(winningValue, checkForWinnerOrTie ticTacToeBox gameTestCreate3X3.playerGlyph gameTestCreate3X3.aIGlyph)
...
let Check_If_Human_Won_Right_3X3_Diangle() =
    let ticTacToeBox = new TicTacToeBox (["X"; "-2-"; "-3-"; "-4-"; "X"; "-6-"; "-7-"; "-8-"; "X"].ToImmutableArray())
    let winningValue = int (getWinningHumanValue(gameTestCreate3X3.ticTacToeBoxSize))
    Assert.Equal(winningValue, checkForWinnerOrTie ticTacToeBox gameTestCreate3X3.playerGlyph gameTestCreate3X3.aIGlyph)

[<Fact>]   // test
let Check_If_Human_Won_Left_3X3_Diangle() =
   let ticTacToeBox = new TicTacToeBox (["-1-"; "-2-"; "X"; "-4-"; "X"; "-6-"; "X"; "-8-"; "-9-"].ToImmutableArray())
   let winningValue = int (getWinningHumanValue(gameTestCreate3X3.ticTacToeBoxSize))
   Assert.Equal(winningValue, checkForWinnerOrTie ticTacToeBox gameTestCreate3X3.playerGlyph gameTestCreate3X3.aIGlyph)
