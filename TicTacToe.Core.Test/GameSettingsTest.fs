...
let Make_A_Incorrect_Box_Size_Setting() =
    ...
    (fun () -> craftGameSetting TicTacToeInccorectBox playerGlyph aIGlyph firstPlayer false false |> ignore) |> should throw typeof<InvaildSizeOfBox>
...
let Make_Same_Glyph_Error() =
    ...
    let aIGlyph = "X"
    let firstPlayer = int playerVals.Human
    (fun () -> craftGameSetting TicTacToeInccorectBox playerGlyph aIGlyph firstPlayer false false |> ignore) |> should throw typeof<InvaildGlyph>
...
let Make_Inncorect_Player() =
    ...
    let aIGlyph = "1"
    let firstPlayer = 999
    (fun () -> craftGameSetting TicTacToeInccorectBox playerGlyph aIGlyph firstPlayer false false |> ignore) |> should throw typeof<InvaildPlayer>
